...
public final class MRProtos {
  ...
  public static final class JobReportProto extends
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasMapProgress()) {
        result = result && (
            java.lang.Float.floatToIntBits(getMapProgress())
            == java.lang.Float.floatToIntBits(
                other.getMapProgress()));
      }
      result = result && (hasReduceProgress() == other.hasReduceProgress());
      if (hasReduceProgress()) {
        result = result && (
            java.lang.Float.floatToIntBits(getReduceProgress())
            == java.lang.Float.floatToIntBits(
                other.getReduceProgress()));
      }
      result = result && (hasCleanupProgress() == other.hasCleanupProgress());
      if (hasCleanupProgress()) {
        result = result && (
            java.lang.Float.floatToIntBits(getCleanupProgress())
            == java.lang.Float.floatToIntBits(
                other.getCleanupProgress()));
      }
      result = result && (hasSetupProgress() == other.hasSetupProgress());
      if (hasSetupProgress()) {
        result = result && (
            java.lang.Float.floatToIntBits(getSetupProgress())
            == java.lang.Float.floatToIntBits(
                other.getSetupProgress()));
      }
      result = result && (hasStartTime() == other.hasStartTime());
      if (hasStartTime()) {
        result = result && (getStartTime()
